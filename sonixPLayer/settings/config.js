module.exports = {
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/api/oauth2/authorize?client_id=885982897251684372&permissions=8&scope=bot%20applications.commands`,
    DiscordServer: process.env.DiscordServer || `https://discord.gg/GJeHBVkTPc`,
    VoteURL: process.env.VoteURL || `https://discord.gg/GJeHBVkTPc`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true
